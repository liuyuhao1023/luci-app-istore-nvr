...
o.cfgvalue = function(self, section)
	...
	return string.format([[<a href="%s" target="_blank" class="cbi-button cbi-button-apply" style="display:inline-block; text-decoration:none; padding: 6px 16px; font-weight: bold; background-color: #3b82f6; color: #fff; border-radius: 4px;">%s &gt;&gt;</a>]],
